                ...
                switch (ig.game.tutorialState) {
                    case 0:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ...
                            this.tutorialText = this.text.Tutorial[0];
                        }
                        break;
                    case 1:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                    ...
                    case 2:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ig.game.currentTutorialState = ig.game.tutorialState;
                            this.tutorialText = this.text.Tutorial[3];
                            this.tween({ addValue: 50 }, 0.5, {
                                loop: ig.Tween.Loop.Reverse,
                            }).start();
                        }
                    ...
                    case 3:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ig.game.currentTutorialState = ig.game.tutorialState;
                            this.tutorialText = this.text.Tutorial[4];
                        }
                        break;
                    case 4:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ig.game.currentTutorialState = ig.game.tutorialState;
                            this.tutorialText = this.text.Tutorial[5];
                            this.currentDisplayNum++;
                        }
                        break;
                    case 5:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ig.game.currentTutorialState = ig.game.tutorialState;
                            this.tutorialText = this.text.Tutorial[6];
                            this.pos.y -= 350;
                            this.setupOffsetPos();
                        }
                        break;
                    case 6:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ig.game.currentTutorialState = ig.game.tutorialState;
                            this.tutorialText = this.text.Tutorial[7];
                        }
                        break;
                    case 7:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                    ...
                    case 9:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
                            ig.game.currentTutorialState = ig.game.tutorialState;
                            this.tutorialText = this.text.Tutorial[10];
                        }
                        break;
                    case 10:
                        if (ig.game.currentTutorialState != ig.game.tutorialState) {
            ...
            draw: function () {
                ...
                if (ig.game.tutorialState != 8) {
                    ...
                    this.wrapText(
                        ...
                        (this.drawPos.y + 50)  * _GAMESETTINGS.screenScale,
                        (this.size.x - 20)  * _GAMESETTINGS.screenScale,
                        (this.size.y - 50)  * _GAMESETTINGS.screenScale,
