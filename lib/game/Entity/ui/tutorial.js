                    ...
                    if (ig.game.tutorialState != 7) {
                        ...
                        if (ig.game.tutorialState == 2) {
                            if (this.currentDisplayNum >= 5) {
                                ctx.fillText(
                                    "click to continue",
                                    this.drawPos.x + this.size.x - 20,
                                    this.drawPos.y + this.size.y - 20
                                );
                            }
                        } else if (ig.game.tutorialState == 3) {
                            console.log(ig.gameplay.flowers[0].currentHeight);
                ...
                switch (ig.game.tutorialState) {
                    case 6:
                        if (typeof ig.gameplay.buttons[0] != "undefined") {
                            ...
                            ctx.beginPath();
                            ctx.rect(
                                ig.gameplay.buttons[0].drawPos.x - 25,
                                ig.gameplay.buttons[0].drawPos.y - 25,
                    ...
                    case 7:
                        for (var i = 0; i < ig.gameplay.buttons.length; i++) {
                            if (
                                ...
                                ctx.beginPath();
                                ctx.rect(
                                    ig.gameplay.buttons[i].drawPos.x - 5,
                                    ig.gameplay.buttons[i].drawPos.y - 5,
                                    ig.gameplay.buttons[i].size.x + 10,
                                    ig.gameplay.buttons[i].size.y + 10
                                );
                                ctx.stroke();
                                ctx.closePath();
                            }
