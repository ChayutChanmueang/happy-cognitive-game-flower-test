...
.defines(function(){
    EntityGameoverPanel = ig.Entity.extend({
        ...
        draw:function(){
            ...
            ctx.fillText(this.text.Gameover, (ig.system.width/2), 100);
            ctx.fillText(this.text.CorrectAnswer + this.right, (ig.system.width/2), 300);
            ctx.fillText(this.text.WrongAnswer + this.wrong, (ig.system.width/2), 350);
        }
    })
})