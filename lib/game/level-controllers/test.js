...
.defines(function(){
    EntityLevelTest = ig.Entity.extend({
        ...
        showChoices:function(){
            ...
            if(ig.ua.mobile){
                this.title = ig.game.spawnEntity(EntityText,(ig.system.width/2),(ig.system.height/2) + 175,
                {
                    anchor:2,
            ...
            for(var i = 0; i < 2; i++){
                for(var j = 0; j < 2; j++){
                    ...
                    if(ig.ua.mobile){
                        var button = ig.game.spawnEntity(EntityChooseButton,((ig.system.width/2) - 205) + (j * (200 + 10)) ,(ig.system.height/2) + 200 + (i * 75),{anchor:2,value:randomValue});
                    }
                    else{
